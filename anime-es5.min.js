...
a*a)},Elastic:function(a,b){if(0===a||1===a)return a;b=1-Math.min(b,998)/1E3;a=a/1-1;return-(Math.pow(2,10*a)*Math.sin(2*(a-b/(2*Math.PI)*Math.asin(1))*Math.PI/b))},Back:function(a){return a*a*(3*a-2)},Bounce:function(a){for(var b,c=4;a<((b=Math.pow(2,--c))-1)/11;);return 1/Math.pow(4,3-c)-7.5625*Math.pow((3*b-2)/22-a,2)}};["Quad","Cubic","Quart","Quint","Expo"].forEach(function(a,c){b[a]=function(a){return Math.pow(a,c+2)}});var c=function(c){var f=b[c];a["easeIn"+c]=f;a["easeOut"+c]=function(a,
c){return 1-f(1-a,c)};a["easeInOut"+c]=function(a,c){return.5>a?f(2*a,c)/2:1-f(-2*a+2,c)/2}},f;for(f in b)c(f);a.linear=function(a){return a};return a}(),w=function(a){return d.string(a)?a:""+a},E=function(a){return a.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase()},F=function(a){if(d.color(a))return!1;try{return document.querySelectorAll(a)}catch(b){return!1}},x=function(a){if(d.array(a))return a;d.string(a)&&(a=F(a)||a);return d.html(a)?[].slice.call(a):[a]},u=function(a){return Array.prototype.reduce.call(a,
function(a,c){return a.concat(d.array(c)?u(c):c)},[])},R=function(a,b){var c={};a.forEach(function(a){var e=JSON.stringify(b.map(function(c){return a[c]}));c[e]=c[e]||[];c[e].push(a)});return Object.keys(c).map(function(a){return c[a]})},y=function(a){return a.filter(function(a,c,f){return f.indexOf(a)===c})},v=function(a){var b={},c;for(c in a)b[c]=a[c];return b},r=function(a,b){for(var c in b)a[c]=d.undef(a[c])?b[c]:a[c];return a},G=function(a){function b(a,b){b.type=a;b.handle={on:function(){e.add(b);
return b.handle},once:function(){return f(a,b)},off:function(){c(b);return b.handle}};e.add(b);return b.handle}function c(a){e.has(a)&&e.delete(a);return a.handle}function f(f,e){if(d.func(e)){var g=function(){var d=function(){e.apply(a,arguments);c(d)};c(e);return{v:b(f,d)}}();if("object"===typeof g)return g.v}}d.object(a)||(a={});var e=new Set;a.listeners=e;a.on=b;a._once=f;a.once=function(c){return new Promise(function(b){a._once(c,b)})};return a},t=function(a,b){var c=arguments;"begin"==a&&(b.started=
!0);0<b.listeners.size&&function(){var f=[].slice.call(c,1);b.listeners.forEach(function(c){c.type==a&&c.apply(b,f.concat(c.handle))})}()},S=function(a){a=a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(a,c,b,d){return c+c+b+b+d+d});var b=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a);a=parseInt(b[1],16);var c=parseInt(b[2],16),b=parseInt(b[3],16);return"rgb("+a+","+c+","+b+")"},z=function(a,b,c){0>c&&(c+=1);1<c&&--c;return c<1/6?a+6*(b-a)*c:.5>c?b:c<2/3?a+(b-a)*(2/3-c)*6:a},n=function(a){return/([\+\-]?[0-9|auto\.]+)(%|px|pt|em|rem|in|cm|mm|ex|pc|vw|vh|deg)?/.exec(a)[2]},
...
a-f;c=z(e,f,b+1/3);a=z(e,f,b);b=z(e,f,b-1/3)}b="rgb("+255*c+","+255*a+","+255*b+")"}else b=void 0;return b}if(n(b))return b;a=n(a.to)?n(a.to):n(a.from);!a&&c&&(a=n(c));return a?b+a:b},L=function(a){var b=/-?\d*\.?\d+/g;return{original:a,numbers:w(a).match(b)?w(a).match(b).map(Number):[0],strings:w(a).split(b)}},U=function(a,b,c){return b.reduce(function(b,e,d){return b+a[d-1]+(e?e:c[d-1])})},M=function(a){return a?u(d.array(a)?a.map(x):x(a)):[]},V=function(a){return M(a).map(function(a,c){return{target:a,
id:c}})},W=function(a,b){var c=[],f;for(f in a)if(!C.hasOwnProperty(f)&&"targets"!==f){var e=d.object(a[f])?v(a[f]):{value:a[f]};e.name=f;c.push(r(e,b))}return c},N=function(a,b,c,f){"transform"===c?(c=a+("("+H(a,b.from,b.to)+")"),b=a+("("+H(a,b.to)+")")):(a="css"===c?A(f,a):void 0,c=K(b,b.from,a),b=K(b,b.to,a));return{from:L(c),to:L(b)}},X=function(a,b){var c=[];a.forEach(function(f,e){var p=f.target;return b.forEach(function(b){var l=I(p,b.name);if(l){var k;k=b.name;var h=b.value,h=x(d.func(h)?
h(p,e):h);k={from:1<h.length?h[0]:J(p,k),to:1<h.length?h[1]:h[0]};h=v(b);h.animatables=f;h.type=l;h.from=N(b.name,k,h.type,p).from;h.to=N(b.name,k,h.type,p).to;h.round=d.color(k.from)||h.round?1:0;h.delay=(d.func(h.delay)?h.delay(p,e,a.length):h.delay)/g.speed;h.duration=(d.func(h.duration)?h.duration(p,e,a.length):h.duration)/g.speed;c.push(h)}})});return c},Y=function(a,b){a=X(a,b);return R(a,["name","from","to","delay","duration"]).map(function(a){var b=v(a[0]);b.animatables=a.map(function(a){return a.animatables});
...
(c={}),c[d]||(c[d]=[]),c[d].push(f)}})});if(c)for(var f in c)a.animatables[f].target.style.transform=c[f].join(" ");t("update",a)},Q=function(a){var b={animatables:V(a.targets),settings:r(a,C),time:0,progress:0,running:!1,started:!1,ended:!1};b.properties=W(a,b.settings);b.tweens=Y(b.animatables,b.properties);b.duration=b.tweens.length?Math.max.apply(Math,b.tweens.map(function(a){return a.totalDuration})):a.duration/g.speed;return G(b)},m=[],k={raf:0,play:function(){k.raf=requestAnimationFrame(k.step)},
pause:function(){cancelAnimationFrame(k.raf);k.raf=0},step:function(a){for(var b=0;b<m.length;b++)m[b].tick(a);k.play()}},da=["complete","begin","update"],g=function(a){var b={},c=Q(a);da.forEach(function(a){if(d.func(c.settings[a]))c["update"==a?"on":"_once"](a,c.settings[a]);"update"!=a&&Object.defineProperty(c,a,{get:function(){return new Promise(function(b){return c._once(a,b)})},set:function(b){d.func(b)&&c._once(a,b)}})});c.tick=function(a){if(c.running){c.ended=!1;b.current=b.last+a-b.start;
var e=c.settings;P(c,b.current);b.current>=c.duration&&(e.loop?(b.start=a,"alternate"===e.direction&&B(c,!0),d.number(e.loop)&&e.loop--):(c.ended=!0,c.pause(!0),t("complete",c)),t("begin",c),b.last=0)}};c.seek=function(a){return P(c,a/100*c.duration)};c.pause=function(a){a||t("pause",c);c.running=!1;aa(c);a=m.indexOf(c);-1<a&&m.splice(a,1);m.length||k.pause();return c};c.play=function(a){a&&(c=r(Q(r(a,c.settings)),c));c.pause(!0);c.running=!0;b.start=performance.now();b.last=c.ended?0:c.time;a=c.settings;
"reverse"===a.direction&&B(c);"alternate"!==a.direction||a.loop||(a.loop=1);Z(c);m.push(c);0==k.raf&&k.play();return c};c.restart=function(){c.reversed&&B(c);t("restart",c);c.pause(!0);c.seek(0);return c.play()};c.settings.autoplay&&c.play();return c};g.all=function(a){return Promise.all(u(arguments).slice(1).map(function(b){return b.once(a)}))};g.remove=function(a){a=M(a);for(var b=m.length-1;0<=b;b--)for(var c=m[b],d=c.tweens.length-1;0<=d;d--)for(var e=c.tweens[d],g=e.animatables.length-1;0<=g;g--)l(a,
e.animatables[g].target)&&(e.animatables.splice(g,1),e.animatables.length||c.tweens.splice(d,1),c.tweens.length||c.pause(!0))};g.speed=1;g.list=m;g.easings=D;g.getValue=J;g.path=function(a){a=d.string(a)?F(a)[0]:a;return{path:a,value:a.getTotalLength()}};g.random=function(a,b){return Math.floor(Math.random()*(b-a+1))+a};g.includes=l;g.cloneObj=v;g.mergeObjs=r;g.flattenArr=u;g.dropArrDupes=y;g.eventsys=G;g.play=k.play;g.pause=k.pause;return g});
